...
{
    public interface IG02Service : IBaseService<torderlist>
    {
        ...
        Task<BaseResult> STOCK_LOAD(BaseParameter BaseParameter);
        Task<BaseResult> tiivaj_HISTORY(BaseParameter BaseParameter);
    }
}
