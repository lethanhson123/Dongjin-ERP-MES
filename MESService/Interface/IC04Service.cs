...
{
    public interface IC04Service : IBaseService<torderlist>
    {
        ...
        Task<BaseResult> DataGridView5_SelectionChanged(BaseParameter BaseParameter);
        Task<BaseResult> DataGridView8_SelectionChanged(BaseParameter BaseParameter);
        Task<BaseResult> Buttonexport_ClickSub(BaseParameter BaseParameter);
    }
}
