...
{
    public interface IFA_M2Service : IBaseService<LineAssignment>
    {
        ...
        Task<BaseResult> GetAssignment(BaseParameter BaseParameter);
        Task<BaseResult> GetLineHistory(BaseParameter BaseParameter);
    }
}