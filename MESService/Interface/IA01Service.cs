...
{
    public interface IA01Service : IBaseService<torderlist>
    {
        ...
        Task<BaseResult> DGV2_LOAD(BaseParameter BaseParameter);
        Task<BaseResult> CB_ADD(BaseParameter BaseParameter);
    }
}
