...
{
    public interface IC01Service : IBaseService<torderlist>
    {
        ...
        Task<BaseResult> COM_LIST(BaseParameter BaseParameter);
        Task<BaseResult> COM_LIST2(BaseParameter BaseParameter);
    }
}
