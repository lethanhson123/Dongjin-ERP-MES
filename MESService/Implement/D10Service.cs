...
{
    public class D10Service : BaseService<torderlist, ItorderlistRepository>
      , ID10Service
    {
        private readonly ItorderlistRepository _torderlistRepository;
        public D10Service(ItorderlistRepository torderlistRepository
        ...
        private async Task<BaseResult> LoadPackingList(string QRCode)
        {
            ...
            if (QRCode.Contains("3S") && QRCode.Contains("ZDA"))
            {
