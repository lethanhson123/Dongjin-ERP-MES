...
{
    public class C11_SPC_RService : BaseService<torderlist, ItorderlistRepository>
    , IC11_SPC_RService
    {
        private readonly ItorderlistRepository _torderlistRepository;
        private readonly IWebHostEnvironment _WebHostEnvironment;
        public C11_SPC_RService(ItorderlistRepository torderlistRepository
            ...
            try
            {
                if (BaseParameter != null)
                {
                    ...
                    if (BaseParameter.ListSearchString != null)
                    {
                        ...
                        sql = @"ALTER TABLE     `torderinspection_sw`     AUTO_INCREMENT= 1";
