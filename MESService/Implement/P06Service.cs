...
{
    public class P06Service : BaseService<torderlist, ItorderlistRepository>, IP06Service
    {
        private readonly ItorderlistRepository _torderlistRepository;
        public P06Service(ItorderlistRepository torderlistRepository) : base(torderlistRepository)
        {
