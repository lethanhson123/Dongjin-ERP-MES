...
$(document).ready(function () {
    localStorage.setItem("C11_3_Close", 0);

    C_EXIT = localStorage.getItem("C11_3_C_EXIT");
    TL_NM = localStorage.getItem("C11_3_TL_NM");
    $("#C11_COUNT3").val(localStorage.getItem("C11_3_C11_COUNT3"));
    $("#C11_D01").val(localStorage.getItem("C11_3_C11_D01"));
    $("#C11_COUNT1").val(localStorage.getItem("C11_3_C11_COUNT1"));
    $("#ORDER").val(localStorage.getItem("C11_3_ORDER"));
...
function C11_3_FormClosed() {
    localStorage.setItem("C11_3_Close", 1);
    window.close();
}
