...
$(document).ready(function () {
    ...
    $("#Label3").val(localStorage.getItem("C02_APPLICATION_Label3"));
    $("#Label1").val(localStorage.getItem("C02_APPLICATION_Label1"));
    $("#Label2").val(localStorage.getItem("C02_APPLICATION_Label2"));
...
function Button2_Click() {
    ...
    let C02_START_Label8 = localStorage.getItem("C02_START_Label8");
    $("#BackGround").css("display", "block");
    let BaseParameter = new Object();
    BaseParameter = {
        ListSearchString: [],
    ...
    BaseParameter.ListSearchString.push(C02_START_Label8);
    let formUpload = new FormData();
    formUpload.append('BaseParameter', JSON.stringify(BaseParameter));
...
function Buttonclose_Click() {
    localStorage.setItem("C02_APPLICATION_Close", 1);
    window.close();
}
