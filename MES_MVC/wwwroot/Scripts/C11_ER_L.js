...
$(document).ready(function () {
    ...
    $("#LBT2S").val(localStorage.getItem("C11_ER_L_LBT2S"));
    $("#LBA2S").val(localStorage.getItem("C11_ER_L_LBA2S"));
    $("#Label1").val(localStorage.getItem("C11_ER_L_Label1"));
...
function Button2_Click() {
    ...
    if ((AA2 == true) && (BB2 == true) && (AA4 == true) && (BB4 == true)) {
        ...
        fetch(url, {
            ...
            response.json().then((data) => {
                localStorage.setItem("C11_1_C_EXIT", false);                
        ...
        localStorage.setItem("C11_1_C_EXIT", true);        
    }
}
...
function C11_ERROR_FormClosed(Flag) {
    ...
    fetch(url, {
        ...
        response.json().then((data) => {
            ...
            localStorage.setItem("C11_ER_L_Close", 1);
            window.close();
        }).catch((err) => {
            $("#BackGround").css("display", "none");
        })
