...
$(document).ready(function () {   
    ...
    $("#LBT2S").val(localStorage.getItem("C11_ER_R_LBT2S"));
    $("#LBA2S").val(localStorage.getItem("C11_ER_R_LBA2S"));
    $("#Label1").val(localStorage.getItem("C11_ER_R_Label1"));
...
function Button2_Click() {
    ...
    if ((AA2 == true) && (BB2 == true) && (AA4 == true) && (BB4 == true)) {
        ...
        fetch(url, {
            ...
            response.json().then((data) => {
                localStorage.setItem("C11_2_C_EXIT", false);
        ...
        localStorage.setItem("C11_2_C_EXIT", true);
    }
}
function C11_2TimerStartInterval() {
    let C11_2Timer = setInterval(function () {
        let C11_2_Close = localStorage.getItem("C11_2_Close");
        if (C11_2_Close == "1") {
            clearInterval(C11_2Timer);
            C11_2_Close = 0;
            localStorage.setItem("C11_2_Close", C11_2_Close);
        }
    }, 100);
}
...
function C11_ERROR_FormClosed(Flag) {
    ...
    fetch(url, {
        ...
        response.json().then((data) => {
            ...
            localStorage.setItem("C11_ER_R_Close", 1);
            window.close();
        }).catch((err) => {
            $("#BackGround").css("display", "none");
        })
