...
$(document).ready(function () {
    ...
    $("#ST11").val(localStorage.getItem("C11_1_ST_DCC1"));
    $("#ST12").val(localStorage.getItem("C11_1_ST_DIC1"));
    $("#Label8").val(localStorage.getItem("C11_VLW"));
    $("#Label18").val(localStorage.getItem("C11_1_WIRE_Length"));
    $("#Label19").val(localStorage.getItem("C11_1_ST_DWIRE1"));
    ...
    for (let i = 0; i < BBBB.length; i++) {
        ...
        $("#Label4").val(localStorage.getItem("C11_1_VLT1"));
        $("#Label5").val(localStorage.getItem("C11_1_VLT1"));
...
function Buttonclose_Click() {
    localStorage.setItem("C11_SPC_L_Close", 1);
    window.close();
}
