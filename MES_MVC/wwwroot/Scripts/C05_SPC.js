...
$(document).ready(function () {
    ...
    OR_IDX = localStorage.getItem("C05_START_Label8");
    localStorage.setItem("C05_START_SPC_EXIT", false);
    ...
    $("#ST11").val(localStorage.getItem("C05_START_Label24"));
    $("#ST12").val(localStorage.getItem("C05_START_Label28"));
    $("#ST21").val(localStorage.getItem("C05_START_Label26"));
    $("#ST22").val(localStorage.getItem("C05_START_Label30"));
    $("#Label8").val(localStorage.getItem("C05_START_VLW"));
    $("#Label18").val(localStorage.getItem("C05_START_WIRE_Length"));
    $("#Label19").val(localStorage.getItem("C05_START_ST_DWIRE1").replace(",", "."));
    ...
    for (let i = 0; i < BBBB.length; i++) {
        ...
        $("#Label4").val(localStorage.getItem("C05_START_VLT1"));
        $("#Label5").val(localStorage.getItem("C05_START_VLT1"));
        $("#Label6").val(localStorage.getItem("C05_START_VLT2"));
        $("#Label7").val(localStorage.getItem("C05_START_VLT2"));
    ...
    if (IsCheck == true) {
        if (MRUS == "OK") {
            ...
            fetch(url, {
                ...
                response.json().then((data) => {
                    $("#BackGround").css("display", "none");
                    localStorage.setItem("C05_START_SPC_EXIT", true);
                    Buttonclose_Click();
                }).catch((err) => {
                    $("#BackGround").css("display", "none");
                })
...
function Buttonclose_Click() {
    localStorage.setItem("C05_SPC_Close", 1);
    window.close();
}
