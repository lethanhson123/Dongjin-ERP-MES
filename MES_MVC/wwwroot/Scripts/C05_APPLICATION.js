...
$(document).ready(function () {
    ...
    $("#Label3").val(localStorage.getItem("C05_APPLICATION_Label3"));
    $("#Label1").val(localStorage.getItem("C05_APPLICATION_Label1"));
    $("#Label2").val(localStorage.getItem("C05_APPLICATION_Label2"));
...
function Button2_Click() {
    ...
    let C05_START_Label8 = localStorage.getItem("C05_START_Label8");
    $("#BackGround").css("display", "block");
    let BaseParameter = new Object();
    BaseParameter = {
        ListSearchString: [],
...
function Buttonclose_Click() {
    localStorage.setItem("C05_APPLICATION_Close", 1);
    window.close();
}
