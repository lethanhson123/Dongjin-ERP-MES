...
export class WarehouseInputService extends BaseService {
    ...
    DisplayColumns012: string[] = ['Save', 'No', 'ID', 'CompanyName', 'SupplierName', 'CustomerName', 'Date', 'Code', 'Name', 'InvoiceInputName', 'WarehouseOutputName', 'ParentName', 'Total', 'TotalFinal', 'Root', 'IsSync', 'IsComplete', 'Active'];
