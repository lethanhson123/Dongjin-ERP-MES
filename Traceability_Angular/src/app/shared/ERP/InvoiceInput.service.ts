...
export class InvoiceInputService extends BaseService {
    ...
    DisplayColumns009: string[] = ['No', 'ID', 'DateETD', 'DateETA', 'Code', 'SupplierName', 'CustomerName', 'OriginalEquipmentManufacturer', 'Total', 'TotalQuantity', 'Active', 'IsComplete', 'IsFuture', 'IsSync'];
