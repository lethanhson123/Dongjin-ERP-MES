...
export class BOMService extends BaseService {
    ...
    DisplayColumns022: string[] = ['No', 'Code', 'ParentID', 'ParentID01', 'ParentID02', 'ParentID03', 'IsLeadNo', 'RowVersion', 'SortOrder', 'RawMaterialCount', 'Quantity', 'BOMCount', 'BundleSize', 'DirT1', 'NoT1', 'DirT2', 'NoT2', 'LeadNo', 'Project', 'Strip1', 'Strip2', 'Item', 'Group', 'WLink', 'Combination',];
    DisplayColumns023: string[] = ['No', 'Quantity',];
    DisplayColumns024: string[] = ['No', 'ParentID', 'ParentID01', 'ParentID02', 'ParentID03', 'ParentID04', 'IsLeadNo', 'Quantity', 'BOMCount', 'Note', 'UpdateDate', 'Project', 'Item', 'Group', 'WLink', 'Display',];
    DisplayColumns025: string[] = ['No', 'ParentID01', 'ParentID02', 'ParentID03', 'IsLeadNo', 'RowVersion', 'SortOrder', 'RawMaterialCount', 'Quantity', 'BOMCount', 'BundleSize', 'DirT1', 'NoT1', 'DirT2', 'NoT2', 'LeadNo', 'Project', 'Strip1', 'Strip2', 'Item', 'Group', 'WLink', 'Combination', 'Code', 'ParentID',];
    ...
    WarehouseOutputDetailBarcodeSaveAndUploadFileAsync() {
        this.Initialization();
        let url = this.APIURL + this.Controller + '/WarehouseOutputDetailBarcodeSaveAndUploadFileAsync';
    ...
    FGSaveAndUploadFileAsync() {
        this.Initialization();
        let url = this.APIURL + this.Controller + '/FGSaveAndUploadFileAsync';
        const formUpload: FormData = new FormData();
        formUpload.append('BaseParameter', JSON.stringify(this.BaseParameter));
        if (this.FileToUpload) {
            if (this.FileToUpload.length > 0) {
