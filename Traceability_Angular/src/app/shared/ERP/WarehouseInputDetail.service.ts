...
export class WarehouseInputDetailService extends BaseService {
    ...
    DisplayColumns030: string[] = ['Save', 'Active', 'No', 'MaterialName', 'Name', 'Display', 'Description', 'IsSNP', 'QuantitySNP', 'Quantity', 'QuantityActual', 'QuantityGAP', 'QuantityInvoice', 'QuantityInvoiceGAP', 'QuantityOutput', 'QuantityInventory', 'CategoryFamilyName', 'CategoryUnitName', 'IsExport', 'UpdateDate', 'UpdateUserCode', 'ID',];
    DisplayColumns031: string[] = ['Save', 'Active', 'No', 'MaterialName', 'Name', 'Display', 'OriginalEquipmentManufacturer','Description', 'IsSNP', 'QuantitySNP', 'Quantity', 'QuantityActual', 'QuantityGAP', 'QuantityInvoice', 'QuantityInvoiceGAP', 'QuantityOutput', 'QuantityInventory', 'CategoryFamilyName', 'CategoryUnitName', 'IsExport', 'UpdateDate', 'UpdateUserCode', 'ID',];
