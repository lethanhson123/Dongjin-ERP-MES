...
export class WarehouseInputDetailBarcodeService extends BaseService {
    ...
    DisplayColumns074: string[] = ['Save', 'Active', 'No', 'ID', 'ParentID', 'ParentName', 'FileName', 'MaterialName', 'Barcode', 'QuantityInventory', 'Quantity', 'QuantityOutput', 'DateScan', 'Description', 'CategoryLocationName', 'QuantitySNP', 'QuantityInvoice', 'UpdateDate', 'UpdateUserCode',];
    DisplayColumns075: string[] = ['Save', 'Active', 'No', 'ID', 'Barcode', 'Quantity', 'DateScan', 'FileName', 'WarehouseInputDetailID', 'MaterialID', 'MaterialName', 'CategoryLocationName', 'QuantityInvoice', 'QuantityInventory', 'Description', 'CategoryFamilyName', 'ECN', 'BOMECNVersion', 'BOMID', 'IsExport', 'CreateDate', 'UpdateDate', 'UpdateUserCode',];
    DisplayColumns076: string[] = ['Save', 'Active', 'No', 'ID', 'ParentID', 'ParentName', 'OriginalEquipmentManufacturer', 'MaterialName', 'Barcode', 'Quantity', 'QuantityOutput', 'QuantityInventory', 'DateScan', 'Description', 'CategoryLocationName', 'QuantitySNP', 'QuantityInvoice', 'UpdateDate', 'UpdateUserCode',];
    DisplayColumns077: string[] = ['Save', 'Active', 'No', 'ID', 'Barcode', 'Quantity', 'DateScan', 'OriginalEquipmentManufacturer', 'WarehouseInputDetailID', 'MaterialID', 'MaterialName', 'CategoryLocationName', 'QuantityInvoice', 'QuantityInventory', 'Description', 'CategoryFamilyName', 'ECN', 'BOMECNVersion', 'BOMID', 'IsExport', 'CreateDate', 'UpdateDate', 'UpdateUserCode',];
    DisplayColumns078: string[] = ['Save', 'Active', 'No', 'ID', 'ParentID', 'ParentName', 'OriginalEquipmentManufacturer', 'MaterialName', 'Barcode', 'Quantity', 'QuantityOutput', 'QuantityInventory', 'DateScan', 'Description', 'Maker', 'CategoryLocationName', 'QuantitySNP', 'QuantityInvoice', 'UpdateDate', 'UpdateUserCode',];
    ...
    SyncByParentID_IsSyncAsync() {
        let url = this.APIURL + this.Controller + '/SyncByParentID_IsSyncAsync';
        const formUpload: FormData = new FormData();
        formUpload.append('BaseParameter', JSON.stringify(this.BaseParameter));
        return this.httpClient.post(url, formUpload, { headers: this.Headers });
    }
    ...
    SaveListScanLocationAsync() {
        let url = this.APIURL + this.Controller + '/SaveListScanLocationAsync';
        const formUpload: FormData = new FormData();
        formUpload.append('BaseParameter', JSON.stringify(this.BaseParameter));
        return this.httpClient.post(url, formUpload, { headers: this.Headers });
    }
     GetStockByCategoryLocationToListAsync() {
        let url = this.APIURL + this.Controller + '/GetStockByCategoryLocationToListAsync';
        const formUpload: FormData = new FormData();
        formUpload.append('BaseParameter', JSON.stringify(this.BaseParameter));
        return this.httpClient.post(url, formUpload, { headers: this.Headers });
    }
