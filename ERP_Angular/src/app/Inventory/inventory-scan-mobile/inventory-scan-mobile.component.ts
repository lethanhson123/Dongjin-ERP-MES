...
@Component({
  selector: 'app-inventory-scan-mobile',
  templateUrl: './inventory-scan-mobile.component.html',
  styleUrls: ['./inventory-scan-mobile.component.css']
})
export class InventoryScanMobileComponent {
  ...
  InventoryDetailActiveChange() {
    ...
    console.log(this.InventoryDetailService.APIURL);
    console.log(this.InventoryDetailService.APIRootURL);
  }
        ...
        if (this.InventoryDetailBarcodeService.BaseParameter.SearchStringFilter.includes("$$")) {
          ...
          if (this.InventoryDetailBarcodeService.ListParent && this.InventoryDetailBarcodeService.ListParent.length > 0) {
            ...
            if (List && List.length > 0) {
              ...
              InventoryDetailBarcode.IsScan = false;
            }
            InventoryDetailBarcode.ParentID = this.InventoryDetailBarcodeService.ListParent[0].ParentID;
          }
          ...
          if (InventoryDetailBarcode.Quantity01 == null) {
            if (InventoryDetailBarcode.ID > 0) {
              ...
              var List = InventoryDetailBarcode.Barcode.split("$$");
              if (List.length > 1) {
                InventoryDetailBarcode.Quantity01 = Number(List[1]);
              }
            }
          }
  ...
  SaveSync() {
    ...
    let ListActive = this.InventoryDetailBarcodeService.ListParent.filter(o => o.Active == true);
    let InventoryDetailBarcodeLocalStorageName = "InventoryDetailBarcode";
    localStorage.setItem(InventoryDetailBarcodeLocalStorageName, JSON.stringify(ListActive));
  ...
  Print() {
    ...
    this.InventoryDetailService.Print2025ByListAsync().subscribe(
      res => {
