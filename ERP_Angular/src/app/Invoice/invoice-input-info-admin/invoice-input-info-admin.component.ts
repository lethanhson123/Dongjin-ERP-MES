...
@Component({
  selector: 'app-invoice-input-info-admin',
  templateUrl: './invoice-input-info-admin.component.html',
  styleUrls: ['./invoice-input-info-admin.component.css']
})
export class InvoiceInputInfoAdminComponent {
...
@ViewChild('InvoiceInputDetailSort') InvoiceInputDetailSort: MatSort;
  ...
  Add(ID: number) {
    this.Router.navigateByUrl("InvoiceInputInfoAdmin/" + ID);
