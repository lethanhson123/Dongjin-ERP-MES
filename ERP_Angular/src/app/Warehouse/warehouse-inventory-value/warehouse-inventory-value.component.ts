...
@Component({
  selector: 'app-warehouse-inventory-value',
  templateUrl: './warehouse-inventory-value.component.html',
  styleUrls: ['./warehouse-inventory-value.component.css']
})
export class WarehouseInventoryValueComponent implements OnInit {
  ...
  @ViewChild('WarehouseInventorySort') WarehouseInventorySort: MatSort;
    ...
    WarehouseInventorySearch() {      
      ...
      this.End = 0;
      this.WarehouseInventoryService.IsShowLoading = true;
      this.WarehouseInventoryService.BaseParameter.Action = 1000;
    ...
    CreateAutoAsync() {
      this.WarehouseInventoryService.IsShowLoading = true;     
      this.WarehouseInventoryService.SyncValueByCategoryDepartmentIDAndYearAndMonthAsync().subscribe(
        res => {
    ...
    WarehouseInventoryExcel() {   
      ...
      let filename = this.CategoryDepartmentService.BaseParameter.BaseModel.Code + "-" + this.WarehouseInventoryService.BaseParameter.Year + "-" + this.WarehouseInventoryService.BaseParameter.Month + "-WarehouseInventoryValue.xlsx";
