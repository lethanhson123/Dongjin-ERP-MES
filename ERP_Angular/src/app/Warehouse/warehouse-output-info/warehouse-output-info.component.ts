...
@Component({
  selector: 'app-warehouse-output-info',
  templateUrl: './warehouse-output-info.component.html',
  styleUrls: ['./warehouse-output-info.component.css']
})
export class WarehouseOutputInfoComponent {
  ...
  WarehouseInputDetailBarcodeSearch() {
    this.WarehouseOutputService.IsShowLoading = true;
    this.WarehouseInputDetailBarcodeService.BaseParameter.CategoryDepartmentID = this.WarehouseOutputService.BaseParameter.BaseModel.SupplierID;
    this.WarehouseInputDetailBarcodeService.GetByCategoryDepartmentID_BarcodeAsync().subscribe(
      res => {
        this.WarehouseInputDetailBarcodeService.BaseResult.BaseModel = (res as BaseResult).BaseModel;
        this.WarehouseInputDetailBarcodeService.BaseResult.BaseModel.SortOrder = 1;
        if (this.WarehouseInputDetailBarcodeService.ListFilter && this.WarehouseInputDetailBarcodeService.ListFilter.length > 0) {
          this.WarehouseInputDetailBarcodeService.BaseResult.BaseModel.SortOrder = this.WarehouseInputDetailBarcodeService.ListFilter.length + 1;
        }
        if (this.WarehouseInputDetailBarcodeService.BaseResult.BaseModel && this.WarehouseInputDetailBarcodeService.BaseResult.BaseModel.ID > 0) {
          let PushCheck = true;
          if (this.WarehouseInputDetailBarcodeService.ListFilter && this.WarehouseInputDetailBarcodeService.ListFilter.length > 0) {
            let ListWarehouseInputDetailBarcode = this.WarehouseInputDetailBarcodeService.ListFilter.filter(o => o.ID == this.WarehouseInputDetailBarcodeService.BaseResult.BaseModel.ID);
            if (ListWarehouseInputDetailBarcode && ListWarehouseInputDetailBarcode.length > 0) {
              PushCheck = false;
            }
          }
          ...
          if (PushCheck == true) {
            if (this.WarehouseInputDetailBarcodeService.BaseParameter.Active == true) {
              let ListWarehouseOutputDetail = this.WarehouseOutputDetailService.List.filter(o => o.MaterialID == this.WarehouseInputDetailBarcodeService.BaseResult.BaseModel.MaterialID);
              if (ListWarehouseOutputDetail && ListWarehouseOutputDetail.length > 0) {
                this.WarehouseInputDetailBarcodeService.ListFilter.push(this.WarehouseInputDetailBarcodeService.BaseResult.BaseModel);
              }
            }
            else {
              this.WarehouseInputDetailBarcodeService.ListFilter.push(this.WarehouseInputDetailBarcodeService.BaseResult.BaseModel);
          ...
          this.WarehouseInputDetailBarcodeService.ListFilter = this.WarehouseInputDetailBarcodeService.ListFilter.sort((a, b) => (a.SortOrder < b.SortOrder ? 1 : -1));
    ...
    this.WarehouseInputDetailBarcodeService.BaseParameter.Barcode = environment.InitializationString;
    this.Barcode.nativeElement.focus();

  }
  WarehouseInputDetailBarcodeSave() {
    for (let i = 0; i < this.WarehouseInputDetailBarcodeService.ListFilter.length; i++) {
      let WarehouseInputDetailBarcode = this.WarehouseInputDetailBarcodeService.ListFilter[i];
      let element: WarehouseOutputDetailBarcode = {
        ID: 0,
        Active: true,
        ParentID: this.WarehouseOutputService.BaseParameter.BaseModel.ID,
        Barcode: WarehouseInputDetailBarcode.Barcode,
        MaterialID: WarehouseInputDetailBarcode.MaterialID,
        Quantity: WarehouseInputDetailBarcode.QuantityInventory,
      };
      this.WarehouseOutputDetailBarcodeSave(element);
    }
    this.WarehouseInputDetailBarcodeService.ListFilter01 = this.WarehouseInputDetailBarcodeService.ListFilter;
    this.WarehouseInputDetailBarcodeService.ListFilter = [];
  }
  WarehouseInputDetailBarcodeSave2026() {
    this.WarehouseOutputService.IsShowLoading = true;
    this.WarehouseOutputDetailBarcodeService.BaseParameter.ParentID = this.WarehouseOutputService.BaseParameter.BaseModel.ID;
    this.WarehouseOutputDetailBarcodeService.BaseParameter.List = [];
    for (let i = 0; i < this.WarehouseInputDetailBarcodeService.ListFilter.length; i++) {
      let WarehouseInputDetailBarcode = this.WarehouseInputDetailBarcodeService.ListFilter[i];
      let element: WarehouseOutputDetailBarcode = {
        ID: 0,
      ...
      this.WarehouseOutputDetailBarcodeService.BaseParameter.List.push(element);
    }
    this.WarehouseOutputDetailBarcodeService.SaveList2026Async().subscribe(
      res => {
        this.WarehouseOutputDetailSearch();
        this.WarehouseOutputDetailBarcodeSearch();
        this.NotificationService.warn(environment.SaveSuccess);
  ...
  WarehouseInputDetailBarcodeDelete(element: WarehouseInputDetailBarcode) {
    this.WarehouseInputDetailBarcodeService.ListFilter = this.WarehouseInputDetailBarcodeService.ListFilter.filter(o => o.ID != element.ID);
    this.WarehouseInputDetailBarcodeService.ListFilter = this.WarehouseInputDetailBarcodeService.ListFilter.sort((a, b) => (a.SortOrder < b.SortOrder ? 1 : -1));
    this.WarehouseInputDetailBarcodeService.DataSource = new MatTableDataSource(this.WarehouseInputDetailBarcodeService.ListFilter);
    this.WarehouseInputDetailBarcodeService.DataSource.sort = this.WarehouseInputDetailBarcodeSort;
    this.WarehouseInputDetailBarcodeService.DataSource.paginator = this.WarehouseInputDetailBarcodePaginator;
  }
  WarehouseInputDetailBarcodePrint2025() {
    this.WarehouseOutputService.IsShowLoading = true;
    this.WarehouseInputDetailBarcodeService.BaseParameter.List = this.WarehouseInputDetailBarcodeService.ListFilter01;
    this.WarehouseInputDetailBarcodeService.PrintByListAsync().subscribe(
      res => {
        this.WarehouseInputDetailBarcodeService.BaseResult = (res as BaseResult);
        this.NotificationService.OpenWindowByURL(this.WarehouseInputDetailBarcodeService.BaseResult.Message);
      },
