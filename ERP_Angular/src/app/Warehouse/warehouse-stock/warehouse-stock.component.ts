...
export class WarehouseStockComponent {
  ...
  constructor(
    ...
    this.WarehouseStockService.BaseParameter.Action = 1;
    this.CompanySearch();
  ...
  WarehouseStockExcel() {
    ...
    let filename = this.CompanyService.BaseParameter.BaseModel.Code + "-" + this.CategoryDepartmentService.BaseParameter.BaseModel.Code + "-" + this.WarehouseStockService.BaseParameter.Year + "-" + this.WarehouseStockService.BaseParameter.Month + "-" + this.WarehouseStockService.BaseParameter.Day + "-WarehouseStock.xlsx";
