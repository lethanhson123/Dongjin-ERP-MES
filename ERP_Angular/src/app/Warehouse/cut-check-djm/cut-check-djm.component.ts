...
@Component({
  selector: 'app-cut-check-djm',
  templateUrl: './cut-check-djm.component.html',
  styleUrls: ['./cut-check-djm.component.css']
})
export class CutCheckDJMComponent {
  ...
  WarehouseInputDetailBarcodeCheck() {
    ...
    if (ListCheck && ListCheck.length > 0) {
      ...
      this.WarehouseInputDetailBarcodeService.GetByBarcodeFromtrackmtimAsync().subscribe(
        res => {
    ...
    if (this.WarehouseInputDetailBarcodeService.BaseParameter.SearchStringFilter && this.WarehouseInputDetailBarcodeService.BaseParameter.SearchStringFilter.length > 0) {
      ...
      if (this.WarehouseInputDetailBarcodeService.BaseParameter.SearchStringFilter == this.WarehouseInputDetailBarcodeService.BaseParameter.SearchString) {
        ...
        if (IsCheck == true) {
          ...
          WarehouseInputDetailBarcode.ParentID = 124;
          ...
          WarehouseInputDetailBarcode.DateScan = this.WarehouseInputDetailBarcodeService.BaseParameter.BaseModel.DateScan;


          WarehouseInputDetailBarcode.SortOrder = this.WarehouseInputDetailBarcodeService.BaseParameter.BaseModel.CategoryLocationID;
          WarehouseInputDetailBarcode.Note = this.WarehouseInputDetailBarcodeService.BaseParameter.BaseModel.CategoryLocationName;
          ...
          if (WarehouseInputDetailBarcode.SortOrder > 0) {
            let audio = new Audio("/Media/SuccessNot.wav");
            audio.play();
          }
