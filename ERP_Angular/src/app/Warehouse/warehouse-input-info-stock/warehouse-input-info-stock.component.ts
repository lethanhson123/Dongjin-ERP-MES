...
@Component({
  selector: 'app-warehouse-input-info-stock',
  templateUrl: './warehouse-input-info-stock.component.html',
  styleUrls: ['./warehouse-input-info-stock.component.css']
})
export class WarehouseInputInfoStockComponent implements OnInit {
  ...
  Add(ID: number) {
    this.Router.navigateByUrl("WarehouseInputInfoStock/" + ID);
