...
@Component({
  selector: 'app-warehouse-input-detail-barcode-diagram',
  templateUrl: './warehouse-input-detail-barcode-diagram.component.html',
  styleUrls: ['./warehouse-input-detail-barcode-diagram.component.css']
})
export class WarehouseInputDetailBarcodeDiagramComponent {
  ...
  constructor(
    ...
    public DialogRef: MatDialogRef<WarehouseInputDetailBarcodeDiagramComponent>,
  ...
  WarehouseInputDetailBarcodeSearch() {
    if (this.WarehouseInputDetailBarcodeService.BaseParameter.SearchString.length > 0) {
      ...
      this.WarehouseInputDetailBarcodeService.IsShowLoading = true;
      this.WarehouseInputDetailBarcodeService.GetByCategoryDepartmentID_MaterialID_CategoryLocationNameFromDiagramToListAsync().subscribe(
        res => {
