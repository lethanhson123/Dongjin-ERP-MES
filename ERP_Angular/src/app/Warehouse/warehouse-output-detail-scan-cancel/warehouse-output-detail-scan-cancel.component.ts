...
@Component({
  selector: 'app-warehouse-output-detail-scan-cancel',
  templateUrl: './warehouse-output-detail-scan-cancel.component.html',
  styleUrls: ['./warehouse-output-detail-scan-cancel.component.css']
})
export class WarehouseOutputDetailScanCancelComponent {
...
@ViewChild('WarehouseOutputSort') WarehouseOutputSort: MatSort;
  ...
  IsWarehouseOutputDetailBarcodeView: boolean = true;
  ...
  WarehouseOutputSearch() {
    ...
    this.WarehouseOutputService.BaseParameter.Action = 2;
