...
@Component({
  selector: 'app-finish-goods-check-djm',
  templateUrl: './finish-goods-check-djm.component.html',
  styleUrls: ['./finish-goods-check-djm.component.css']
})
export class FinishGoodsCheckDJMComponent {
      ...
      if (this.WarehouseInputDetailBarcodeService.BaseParameter.SearchStringFilter == this.WarehouseInputDetailBarcodeService.BaseParameter.SearchString) {
        ...
        if (IsCheck == true) {
          for (let i = 0; i < this.WarehouseInputDetailBarcodeService.ListParent.length; i++) {
            ...
            WarehouseInputDetailBarcode.ParentID = 122;
