...
@Component({
  selector: 'app-warehouse-input-admin',
  templateUrl: './warehouse-input-admin.component.html',
  styleUrls: ['./warehouse-input-admin.component.css']
})
export class WarehouseInputAdminComponent {
  ...
  WarehouseInputDelete(element: WarehouseInput) {
    if (confirm(environment.DeleteConfirm)) {
      ...
      this.WarehouseInputService.RemoveAsync().subscribe(
        res => {
  ...
  CreateAutoAsync() {
    this.WarehouseInputService.IsShowLoading = true;
    this.WarehouseInputService.CreateAutoAsync().subscribe(
      res => {
      },
      err => {
      },
