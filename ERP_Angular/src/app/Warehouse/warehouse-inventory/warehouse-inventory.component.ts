...
export class WarehouseInventoryComponent {
  ...
  WarehouseInventorySearch() {
    ...
    //   if (this.WarehouseInventoryService.BaseParameter.SearchString.includes(";")) {
    //     SearchString = this.WarehouseInventoryService.BaseParameter.SearchString.split(';');
    //   }
    //   else {
    //     SearchString = this.WarehouseInventoryService.BaseParameter.SearchString.split(' ');
    //   }      
    //   let List0 = this.WarehouseInventoryService.List.filter(o => o.SortOrder == environment.InitializationNumber);
    //   let List = this.WarehouseInventoryService.List.filter(o => (o.Code && o.Code.length > 0 && SearchString.includes(o.Code)));
    //   if (List0) {
    //     if (List0.length > 0) {
    //       List.push(List0[0]);
    //     }
    ...
    this.End = 0;
    this.WarehouseInventoryService.IsShowLoading = true;
    this.WarehouseInventoryService.BaseParameter.Action = 1;
  ...
  CreateAutoAsync() {
    this.WarehouseInventoryService.IsShowLoading = true;
    console.log(this.WarehouseInventoryService.BaseParameter.CategoryDepartmentID);
    console.log(this.WarehouseInventoryService.BaseParameter.Year);
    console.log(this.WarehouseInventoryService.BaseParameter.Month);
    this.WarehouseInventoryService.SyncByCategoryDepartmentIDAndYearAndMonthAsync().subscribe(
      res => {
  ...
  WarehouseInventoryExcel() {   
    ...
    let filename = this.CategoryDepartmentService.BaseParameter.BaseModel.Code + "-" + this.WarehouseInventoryService.BaseParameter.Year + "-" + this.WarehouseInventoryService.BaseParameter.Month + "-WarehouseInventory.xlsx";
