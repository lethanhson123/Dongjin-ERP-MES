...
import { ProductionOrderFile } from './ProductionOrderFile.model';
...
export class ProductionOrderFileService extends BaseService {
    ...
    List: ProductionOrderFile[] | undefined;
    ListFilter: ProductionOrderFile[] | undefined;
    FormData!: ProductionOrderFile;
    APIURL: string = environment.APIProductionOrderURL;
    APIRootURL: string = environment.APIProductionOrderRootURL;
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.Controller = "ProductionOrderFile";
    }
}
