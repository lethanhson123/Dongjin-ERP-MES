...
import { CategoryLayer } from './CategoryLayer.model';
...
export class CategoryLayerService extends BaseService {
    DisplayColumns001: string[] = ['No', 'ID', 'ParentID', 'ParentName', 'CreateDate', 'CreateUserID', 'CreateUserCode', 'CreateUserName', 'UpdateDate', 'UpdateUserID', 'UpdateUserCode', 'UpdateUserName', 'RowVersion', 'SortOrder', 'Active', 'Code', 'Name', 'Display', 'Description', 'Note', 'FileName', 'CompanyID', 'CompanyName', 'Save'];
    DisplayColumns002: string[] = ['No', 'ID', 'CompanyName', 'Code', 'Name', 'Display', 'Note', 'SortOrder', 'Active', 'Save'];

    List: CategoryLayer[] | undefined;
    ListFilter: CategoryLayer[] | undefined;
    FormData!: CategoryLayer;
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.Controller = "CategoryLayer";
    }
