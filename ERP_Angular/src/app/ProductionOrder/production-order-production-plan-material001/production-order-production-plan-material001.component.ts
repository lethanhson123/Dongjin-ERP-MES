...
@Component({
  selector: 'app-production-order-production-plan-material001',
  templateUrl: './production-order-production-plan-material001.component.html',
  styleUrls: ['./production-order-production-plan-material001.component.css']
})
export class ProductionOrderProductionPlanMaterial001Component {
  ...
  ProductionOrderProductionPlanMaterialChange(files: FileList) {
    if (files) {
      this.ProductionOrderProductionPlanMaterialService.FileToUpload = files;
    }
  }
  ProductionOrderMaterialChange(files: FileList) {
    if (files) {
  ...
  ProductionOrderProductionPlanMaterialSearch() {
    if (this.ProductionOrderMaterialService.BaseParameter.ParentID > 0) {
      if (this.ProductionOrderProductionPlanMaterialService.BaseParameter.SearchString.length > 0) {
        ...
        this.ProductionOrderProductionPlanMaterialService.GetByParentIDToListAsync().subscribe(
          res => {
            ...
            this.ProductionOrderProductionPlanMaterialService.List = (res as BaseResult).List;
  ...
  ProductionOrderOutputScheduleSearch() {
    if (this.ProductionOrderMaterialService.BaseParameter.ParentID > 0) {
      if (this.ProductionOrderOutputScheduleService.BaseParameter.SearchString.length > 0) {
        ...
        this.ProductionOrderOutputScheduleService.BaseParameter.ParentID = this.ProductionOrderProductionPlanMaterialService.BaseParameter.ParentID;
        this.ProductionOrderService.IsShowLoading = true;
  ...
  ProductionOrderOutputScheduleSave(element: ProductionOrderOutputSchedule) {
    ...
    element.ParentID = this.ProductionOrderProductionPlanMaterialService.BaseParameter.ParentID;
