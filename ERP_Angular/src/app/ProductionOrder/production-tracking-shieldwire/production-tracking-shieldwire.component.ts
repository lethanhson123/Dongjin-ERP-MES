...
@Component({
  selector: 'app-production-tracking-shieldwire',
  templateUrl: './production-tracking-shieldwire.component.html',
  styleUrls: ['./production-tracking-shieldwire.component.css']
})
export class ProductionTrackingSHIELDWIREComponent {
  ...
  constructor(
    ...
    public DialogRef: MatDialogRef<ProductionTrackingSHIELDWIREComponent>,
  ...
  WarehouseInputDetailBarcodeSearch() {
    ...
    this.WarehouseInputDetailBarcodeService.GetBySHIELDWIRE_SearchStringToListAsync().subscribe(
      res => {
