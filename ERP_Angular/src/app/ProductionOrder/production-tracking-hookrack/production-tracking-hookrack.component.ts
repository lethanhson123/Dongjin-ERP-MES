...
@Component({
  selector: 'app-production-tracking-hookrack',
  templateUrl: './production-tracking-hookrack.component.html',
  styleUrls: ['./production-tracking-hookrack.component.css']
})
export class ProductionTrackingHOOKRACKComponent {
