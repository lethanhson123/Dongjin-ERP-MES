...
@Component({
  selector: 'app-production-tracking-komax',
  templateUrl: './production-tracking-komax.component.html',
  styleUrls: ['./production-tracking-komax.component.css']
})
export class ProductionTrackingKOMAXComponent {
  ...
  constructor(
    ...
    public DialogRef: MatDialogRef<ProductionTrackingKOMAXComponent>,
  ...
  WarehouseInputDetailBarcodeSearch() {
    ...
    this.WarehouseInputDetailBarcodeService.GetByKOMAX_SearchStringToListAsync().subscribe(
      res => {
