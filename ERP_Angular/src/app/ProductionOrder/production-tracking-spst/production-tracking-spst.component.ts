...
@Component({
  selector: 'app-production-tracking-spst',
  templateUrl: './production-tracking-spst.component.html',
  styleUrls: ['./production-tracking-spst.component.css']
})
export class ProductionTrackingSPSTComponent {
...
@ViewChild('WarehouseInputDetailBarcodeSortFilter') WarehouseInputDetailBarcodeSortFilter: MatSort;
  ...
  constructor(
    ...
    public DialogRef: MatDialogRef<ProductionTrackingSPSTComponent>,
  ...
  WarehouseInputDetailBarcodeSearch() {
    ...
    this.WarehouseInputDetailBarcodeService.GetBySPST_SearchStringToListAsync().subscribe(
      res => {
