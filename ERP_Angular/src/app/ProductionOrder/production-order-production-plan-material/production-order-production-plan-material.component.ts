...
@Component({
  selector: 'app-production-order-production-plan-material',
  templateUrl: './production-order-production-plan-material.component.html',
  styleUrls: ['./production-order-production-plan-material.component.css']
})
export class ProductionOrderProductionPlanMaterialComponent {
