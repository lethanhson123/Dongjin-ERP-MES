...
@Component({
  selector: 'app-production-order-production-plan-backup-modal',
  templateUrl: './production-order-production-plan-backup-modal.component.html',
  styleUrls: ['./production-order-production-plan-backup-modal.component.css']
})
export class ProductionOrderProductionPlanBackupModalComponent {
  ...
  constructor(
    ...
    public DialogRef: MatDialogRef<ProductionOrderProductionPlanBackupModalComponent>,
