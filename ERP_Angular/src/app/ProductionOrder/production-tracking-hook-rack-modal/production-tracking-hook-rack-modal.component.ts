...
@Component({
  selector: 'app-production-tracking-hook-rack-modal',
  templateUrl: './production-tracking-hook-rack-modal.component.html',
  styleUrls: ['./production-tracking-hook-rack-modal.component.css']
})
export class ProductionTrackingHookRackModalComponent {
...
@ViewChild('WarehouseInputDetailBarcodeSortFilter') WarehouseInputDetailBarcodeSortFilter: MatSort;
  ...
  constructor(
    ...
    public DialogRef: MatDialogRef<ProductionTrackingHookRackModalComponent>,
  ...
  WarehouseInputDetailBarcodeSearch() {
    ...
    this.WarehouseInputDetailBarcodeService.GetByHOOKRACK_SearchStringToListAsync().subscribe(
      res => {
